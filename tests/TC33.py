...
input_file.send_keys('/home/aphroth/Downloads/docxs/Guía-Taller Extracción, Análisis y Almacenamiento de Datos con la API de Comtrade.docx')
nombre_archivo = os.path.basename('/home/aphroth/Downloads/docxs/Guía-Taller Extracción, Análisis y Almacenamiento de Datos con la API de Comtrade.docx')
