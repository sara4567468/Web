...
driver.find_element(By.ID, "inscribirEstudianteBtn").click()
campo_id_estudiante=driver.find_element(By.ID, "estudiante_id")
driver.find_element(By.ID, "estudiante_id").send_keys()
time.sleep(5)
driver.find_element(By.CSS_SELECTOR, "button[type='submit']").click()
time.sleep(4)
