...
input_file.send_keys('/home/aphroth/Downloads/iso/cachyos-handheld-linux-250330.iso')
nombre_archivo = os.path.basename('/home/aphroth/Downloads/iso/cachyos-handheld-linux-250330.iso')
